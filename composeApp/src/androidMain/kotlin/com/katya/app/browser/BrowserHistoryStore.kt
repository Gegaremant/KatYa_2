...
class BrowserHistoryStore private constructor(private val context: Context) {
    ...
    companion object {
        ...
        fun getInstance(context: Context): BrowserHistoryStore = instance ?: synchronized(this) {
    ...
    fun uniqueDomains(): List<String> = entries.map { it.domain }.filter { it.isNotEmpty() }.distinct().sorted()
