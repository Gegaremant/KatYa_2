...
import com.katya.app.data.HeartbeatConfig
...
import com.katya.app.data.ServiceInstance
import com.katya.app.data.SmsDraft
import com.katya.app.data.SmsSyncState
import com.katya.app.data.SystemPromptVariant
...
class FakeDataRepository : DataRepository {
    ...
    override suspend fun ask(
        ...
        uiSubmission: com.katya.app.data.UiSubmission?,
    ...
    var skills: List<com.katya.app.skills.SkillManifest> = emptyList()

    override fun getInstalledSkills(): List<com.katya.app.skills.SkillManifest> = skills
    override suspend fun uninstallSkill(id: String) {}
    override suspend fun browseSkillMarketplaces(): Result<List<com.katya.app.skills.RegistrySkillEntry>> = Result.success(emptyList())
    override suspend fun installBrowsedSkill(entry: com.katya.app.skills.RegistrySkillEntry): Result<com.katya.app.skills.SkillManifest> = Result.failure(NotImplementedError())
    override suspend fun installGitHubSkill(owner: String, repo: String, ref: String, path: String): Result<com.katya.app.skills.SkillManifest> = Result.failure(NotImplementedError())
    ...
    override fun getNotificationSyncState(): com.katya.app.data.NotificationSyncState = com.katya.app.data.NotificationSyncState()
