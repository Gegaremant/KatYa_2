...
import com.katya.app.ui.dynamicui.KatyaUiNode
...
@Immutable
data class KatyaUiBlock(val node: KatyaUiNode, val rawJson: String) : BlockNode

@Immutable
data class KatyaUiError(val rawJson: String) : BlockNode
