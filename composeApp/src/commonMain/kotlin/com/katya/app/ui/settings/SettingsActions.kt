...
data class SettingsActions(
    ...
    val onChangeVoiceUiMode: (com.katya.app.data.VoiceUiMode) -> Unit,
    val onToggleWakeWord: (Boolean) -> Unit,
    val onChangeWakeWordTrigger: (String) -> Unit,
    val setWakeWordModelLang: (String) -> Unit,
    val setIsWakeWordVibrationEnabled: (Boolean) -> Unit,
    val setIsWakeWordSoundEnabled: (Boolean) -> Unit,
    ...
    companion object {
        val NoOp = SettingsActions(
            ...
            setWakeWordModelLang = {},
            setIsWakeWordVibrationEnabled = {},
            setIsWakeWordSoundEnabled = {},
            onDownloadVosk = {},
            onAddQuickAction = {},
            onUpdateQuickAction = {},
            onDeleteQuickAction = {},
