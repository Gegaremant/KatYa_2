...
import com.katya.app.data.NotificationRecord
...
import katya.composeapp.generated.resources.tool_check_notifications_description
import katya.composeapp.generated.resources.tool_check_notifications_name
import katya.composeapp.generated.resources.tool_read_notification_description
import katya.composeapp.generated.resources.tool_read_notification_name
import katya.composeapp.generated.resources.tool_search_notifications_description
import katya.composeapp.generated.resources.tool_search_notifications_name
    ...
    fun checkNotificationsTool(store: NotificationStore, reader: NotificationReader) = object : Tool {
        ...
        override suspend fun execute(args: Map<String, Any>): Any {
            ...
            if (!reader.hasAccess()) {
                return mapOf(
                    "success" to false,
                    "error" to "Notification access not granted. Ask the user to enable Katya under " +
