...
## v3.1.5-git
### Added & Improved
- **VLESS Proxy:** Исправлен откат конфигурации при долгом подключении.
- **Диктовка:** Добавлено авторасширение поля ввода при голосовой диктовке в полноэкранном режиме.
- **Импорт/Экспорт:** Добавлено сохранение новых полей (vless_proxy_profiles, active_vless_proxy_id, active_connection_mode, agent_visibility_enabled).
- **God Mode:** Добавлена задержка 15 секунд для запроса Root прав, а также синхронизация состояния UI (индикатор загрузки).
